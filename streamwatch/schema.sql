...
('Adin Ross', 'Vlog', 'Twitch', 'known for his high-profile collaboration and reaction videos.', NULL);
...
('Ludwig', 'Entertainment', 'YouTube', 'A popular streamer and host famouse high-stakes gaming marathon, creative events, and comedy commentary.', NULL);
...
('SSSniperWolf', 'Gaming', 'YouTube', 'A creator famouse for reacting to viral videos, internet stories, and sharing interesting online content.', NULL);
...
('Marlon', 'Entertainment', 'YouTube', 'A creator known for his casula vlogs centered around online trends and variety content.', NULL);
